  ...
  return (
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header style={{ color: '#fff', background: '#222', border: 'none' }} closeButton>
          <Modal.Title>Modal heading</Modal.Title>
        </Modal.Header>
        <Modal.Body style={{ color: '#fff', background: '#222' }}>Woohoo, you are reading this text in a modal!</Modal.Body>
        <Modal.Footer style={{ color: '#fff', background: '#222', border: 'none' }}>
